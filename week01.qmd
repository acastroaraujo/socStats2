...
The variable `T` depicts whether the someone got the "treatment" or not.
...
::: callout-note
-   Simulate a new completely randomized experiment on these 8 people; that is, re sample $T$ at random with the constraint that equal numbers get the treatment and the control.
...
-   Do this a couple of different times (at least 3) and note the differences.
:::
...
::: callout-note
How do these estimates compare the to the "real" ATE?
...
-   Assuming the ATE is $0.125$, how meany people would you need to enroll in this experiment to have enough statistical power?
:::
